...
export class Water extends THREE.Mesh {
    ...
    constructor(heightMap?: THREE.Texture) {
        const planeSize = 100; // Increase this value to make the plane larger
        ...
        const uniforms = {
            ...
            tile: { value: new THREE.Vector2(50.0, 50.0) }, // Scale this proportionally to planeSize
            height: { value: 2.0 },
        ...
        const fragmentShader = `
            ...
            uniform vec4 WATER2_COL;
            uniform vec4 FOAM_COL;
            ...
            void main() {
                vec2 uv = vUv;
                vec3 color = water(uv * tile, vec3(0.0, 1.0, 0.0), time * distortion_speed);
    ...
    private startAnimation() {
        const animate = () => {
            this.uniforms.time.value = performance.now() * 0.001; // Convert to seconds
